...
BEGIN
    CREATE TABLE dbo.ParkingTickets (
        ...
        CONSTRAINT CK_ParkingTickets_Status CHECK (Status IN ('ACTIVE', 'COMPLETED', 'CANCELLED', 'LOST')),
...
DECLARE @PasswordHash VARCHAR(100) = '$2y$10$Z1FmS4w9Dm4lKY.hgC7LDubzpz.KmgCvW3XOMS4CSuo9S71BU4/da';
...
IF NOT EXISTS (
    ...
    SELECT '0002100002', cg.CardGroupID, v.CustomerID, v.VehicleID, f.FloorID, '2026-06-01', '2026-06-01', '2026-12-01', 'ACTIVE'
...
IF NOT EXISTS (
    ...
    INSERT dbo.Cards(RFIDUID, CardGroupID, CustomerID, VehicleID, PreferredFloorID, RegisteredAt, EffectiveFrom, ExpireAt, Status)
    SELECT '0002100006', cg.CardGroupID, v.CustomerID, v.VehicleID, f.FloorID, '2026-05-01', '2026-05-01', '2026-11-01', 'ACTIVE'
    FROM dbo.CardGroups cg CROSS JOIN dbo.Vehicles v CROSS JOIN dbo.Floors f
